...
Uses temp SQLite-backed MLflow tracking. No server required.
"""
...
@pytest.fixture
def tracking_uri(mlflow_tmp_dir):
    """SQLite tracking URI — avoids FutureWarning from filesystem backend."""
    return f"sqlite:///{mlflow_tmp_dir}/mlflow.db"


@pytest.fixture
def logger(tracking_uri):
    """Create an MLflowLogger pointing to a temp SQLite tracking URI."""
    return MLflowLogger(tracking_uri=tracking_uri)
...
class TestMLflowLogger:
    ...
    def test_log_child_run_creates_experiment(self, logger, tracking_uri, mlflow_tmp_dir):
    ...
    def test_child_run_has_git_sha(self, logger, tracking_uri):
    ...
    def test_parent_child_relationship(self, logger, tracking_uri):
    ...
    def test_metrics_logged(self, logger, tracking_uri):
    ...
    def test_params_logged(self, logger, tracking_uri):
    ...
    def test_artifacts_logged(self, logger, tracking_uri):
    ...
    def test_second_child_reuses_parent(self, logger, tracking_uri):
    ...
    def test_custom_tags_preserved(self, logger, tracking_uri):
